...
// Doubao CN (www.doubao.com) adapter, kept alongside Dola per user decision
// 2026-09-15 (dual CN/INTL in the picker, INTL default). This selector set is
// the original CN-tuned one; re-verify against live DOM if doubao.cn changes.
export class DoubaoCnAdapter extends BaseProviderAdapter {
